...
class Genderbeliefs_add(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["gender"] and player.participant.task == "math":
            return True
...
class Genderbeliefs_seq(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["gender"] and player.participant.task == "sequence":
            return True
...
class Racebeliefs_add(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["race"] and player.participant.task == "math":
            return True
...
class Racebeliefs_seq(Page):
    form_model = 'player'
    form_fields = ['l_asian1', 'l_asian2', 'l_asian3', 'l_hispanic1', 'l_hispanic2', 'l_hispanic3',
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["race"] and player.participant.task == "sequence":
            return True
...
class Partybeliefs_add(Page):
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["party"] and player.participant.task == "math":
            return True
...
class Partybeliefs_seq(Page):
    form_model = 'player'
    form_fields = ['l_democrat1', 'l_democrat2', 'l_democrat3', 'l_republican1', 'l_republican2', 'l_republican3'
                   ]
    ...
    @staticmethod
    def is_displayed(player: Player):
        if player.round_number == player.participant.task_rounds["party"] and player.participant.task == "sequence":
            return True
